...
import com.test.sample.springmicroservice.user.User;
import com.test.sample.springmicroservice.user.UserRepository;
import com.test.sample.springmicroservice.user.UserService;
